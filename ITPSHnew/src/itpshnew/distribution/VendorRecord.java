...
public class VendorRecord extends Distribution {
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        try
        {
            ...
            {
                JOptionPane.showMessageDialog(null,"Calculate Shipping Cost", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
            if(!jTextField46.getText().equals(""))                
                itemcost = jTextField46.getText();
            else{
                JOptionPane.showMessageDialog(null,"Calculate Item Cost", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
            type = "Vendor";
            ...
            {
                if(!validate_vendor.executeQuery("select 1 from shipping_rec where Shipping_ID = '"+SID+"'").next()){
                    
                
                validate_vendor.execute("Insert into shipping_rec values('"+SID+"','"+VID+"','"
                    +modelCode+"','"+type+"','"+itemcost+"','"+shipcost+"',"+DateTimeFunctions.getDay()
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        ...
        try
        {
            ...
            a.next();
            int price = a.getInt("sellingprice");
