    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        try
        {
            ...
            if(!jTextField53.getText().equals(""))                
                ...
                JOptionPane.showMessageDialog(null,"Calculate Cost", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
            type = "Retail";
            ...
            if(validate_vendor.executeQuery("select 1 from vendor where Vendor_ID = '"+VID+"'").next())
            {
                validate_vendor.execute("Insert into shipping_rec values('"+SID+"','"+VID+"','"
                    +modelCode+"','"+type+"','"+itemcost+"',null,"+DateTimeFunctions.getDay()
            ...
            {
                JOptionPane.showMessageDialog(null,"No such VID", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
        }
