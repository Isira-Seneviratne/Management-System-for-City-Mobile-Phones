...
<?php
			    ...
			    return $data;
						   ...
						   $mob_brand = $mob_name = $memory = $os_version = $display = $dimension = $camera = $device_condition = $network = $sound = $warrnty = $battery = $price = "";
	            ...
	            if (empty($_POST["warrenty"])) {
	      		$warrentyErr = "* Warranty type is required";
	      		} else {
...
.error {color: #FF0000;}
      ...
      <form class="form-horizontal" role="form" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
        <div class="col-md-12">
          ...
          <label for="brand" class="col-md-4" style="padding-left:12%;padding-top:15px;">
            Mobile Brand:
          </label>
          <div class="col-md-7">
        ...
        <div class="col-md-12">
          ...
          <label for="mobname" class="col-md-4" style="padding-left:12%;padding-top:15px">
            Mobile Name:
          </label>
          <div class="col-md-7">
         ...
         <div class="col-md-12">
          <label for="memory" class="col-md-4" style="padding-left:12%;padding-top:15px">
            Memory:
          </label>
          <div class="col-md-7">
            <input type="text" name="memory" class="form-control"  placeholder="Enter Memory Size in GB"  style="border-radius:7px">
        ...
        <div class="col-md-12">
          <label for="osversion" class="col-md-4" style="padding-left:12%;padding-top:15px">
            OS Version :
          </label>
          <div class="col-md-7">
        ...
        <div class="col-md-12">
          <label for="displaysize" class="col-md-4" style="padding-left:12%;padding-top:15px">
            Display Size:
          </label>
          <div class="col-md-7">
            <input type="text" name="display" class="form-control"  placeholder="Enter Display Size in inches " style="border-radius:7px">
        ...
        <div class="col-md-12">
          <label for="dimension" class="col-md-4" style="padding-left:12%;padding-top:15px">
            Dimension(mm):
          </label>
          <div class="col-md-7">
            <input type="text" name="dimension" class="form-control" placeholder="Enter Dimension in (length*width*height)" style="border-radius:7px">
        ...
        <div class="col-md-12">
          <label for="camera" class="col-md-4" style="padding-left:12%;padding-top:15px">
            Camera:
          </label>
          <div class="col-md-7">
        ...
        <div class="col-md-12">
          <label for="device_condition" class="col-md-4" style="padding-left:12%;padding-top:15px">
            Device Condition:
          </label>
          <div class="col-md-7">
        ...
        <div class="col-md-12">
          <label for="Network" class="col-md-4" style="padding-left:12%;padding-top:15px">
            Network:
          </label>
          <div class="col-md-7">
        ...
        <div class="col-md-12">
          <label for="sound" class="col-md-4" style="padding-left:12%;padding-top:15px">
            Sound:
          </label>
          <div class="col-md-7">
        ...
        <div class="col-md-12">
          <label for="warranty" class="col-md-4" style="padding-left:12%;padding-top:15px">
            Warranty(years):
          </label>
          <div class="col-md-7">
            <input type="text" name="warrenty" class="form-control" placeholder="Enter Warranty Period in years" style="border-radius:7px">
        ...
        <div class="col-md-12">
          <label for="Battery" class="col-md-4" style="padding-left:12%;padding-top:15px">
            Battery:
          </label>
          <div class="col-md-7">
        ...
        <div class="col-md-12">
          <label for="warrenty" class="col-md-4" style="padding-left:12%;padding-top:15px">
            Price(Rs):
          </label>
          <div class="col-md-7">
            <input type="text" name="price" class="form-control" placeholder="Enter Price in Rupees" style="border-radius:7px">
      ...
      <script>
function openWin() {
    window.open("http://localhost/web/admin/mobiledetails.php");
}
</script>
 <div class="col-md-12">         
          <div class="row text-center" style="padding-top: 2%">
	  <a href="mobiledetails.php" > view</a>
