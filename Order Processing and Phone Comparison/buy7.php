...
function net(){
	var x1 = document.getElementById('45900').value;
	var x = parseInt(x1);
...
<div class="col-md-9">
	<div class="col-md-5 grid">		
		<div class="flexslider">
			  <ul class="slides">
			    <li data-thumb="images/buy7iii.jpg">
			        <div class="thumb-image"> <img src="buy7iii.jpg" class="img-responsive"> </div>
			    </li>
			    <li data-thumb="images/buy7i.jpg">
			         <div class="thumb-image"> <img src="images/buy7i.jpg" class="img-responsive"> </div>
			    </li>
			    <li data-thumb="images/buy7ii.jpg">
			       <div class="thumb-image"> <img src="images/buy7ii.jpg" class="img-responsive"> </div>
			    </li> 
			  </ul>
		</div>
	</div>	
...
<div class="col-md-7 single-top-in">
				...
				//else
					//{echo 'data not enter';}
							...
							<h1>MICROSOFT Lumia 950</h1>
							<div id="details"></div>
					</br>
							The Microsoft Lumia 950 proves that there's a lot going for Windows 10 Mobile, though also a lot of work to be done. Its best trick is that it blows up to desktop-like proportions with Continuum, but it sorely needs apps.
							<form action ="buy7.php" method="post" name="input" class="buy"> 
							<table width="50%" border="1" cellspacing="0" cellpadding="0">
								  <tbody class="buy"> <tr>
								      <td width="40%">ITEM ID
							          <input type="text" name="id" readonly value="10017"></td>
								      <td width="60%">ITEM NAME
							            <input type="text" name="product" readonly id="s1001" value="MICROSOFT Lumia 950"></td>
							        </tr>
								    <tr>
								      <td width="40%">PRICE (LKR) :</td>
								      <td width="60%"><input type="text" name="price" readonly id="45900" value="45900"></td>
							        </tr>
								    <tr>
								      <td>QTY :</td>
								      <td>
