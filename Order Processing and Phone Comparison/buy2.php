...
function net(){
	var x1 = document.getElementById('99900').value;
	var x = parseInt(x1);
...
<div class="col-md-9">
	<div class="col-md-5 grid">		
		<div class="flexslider">
			  <ul class="slides">
			    <li data-thumb="images/buy2i.jpg">
			        <div class="thumb-image"> <img src="images/buy2i.jpg" class="img-responsive"> </div>
			    </li>
			    <li data-thumb="images/buy2ii.jpg">
			         <div class="thumb-image"> <img src="images/buy2ii.jpg" class="img-responsive"> </div>
			    </li>
			    <li data-thumb="images/buy2iii.jpg">
			       <div class="thumb-image"> <img src="images/buy2iii.jpg" class="img-responsive"> </div>
			    </li> 
			  </ul>
		</div>
	</div>	
...
<div class="col-md-7 single-top-in">
				...
				//else
					...
					Both chips are manufactured by <strong>Samsung</strong> with a 10 nm process. They contain 64 GB of internal storage, expandable via microSD card. The <strong>Galaxy S8</strong> is one of the first smartphones to support Bluetooth 5, supporting new capabilities such as connecting two wireless headphones to the device at once.
					<form action ="buy2.php" method="post" name="input" class="buy"> 
			<table width="50%" border="1" cellspacing="0" cellpadding="0">
								  <tbody class="buy"> <tr>
								      <td width="40%">ITEM ID
							          <input type="text" name="id" readonly value="10012"></td>
								      <td width="60%">ITEM NAME
							            <input type="text" name="product" readonly id="s1001" value="SAMSUNG S8"></td>
							        </tr>
								    <tr>
								      <td width="40%">PRICE (LKR) :</td>
								      <td width="60%"><input type="text" name="price" readonly id="99900" value="99900"></td>
							        </tr>
								    <tr>
								      <td>QTY :</td>
								      <td>
