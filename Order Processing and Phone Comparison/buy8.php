...
function net(){
	var x1 = document.getElementById('35900').value;
	var x = parseInt(x1);
...
<div class="col-md-9">
	<div class="col-md-5 grid">		
		<div class="flexslider">
			  <ul class="slides">
			    <li data-thumb="images/buy8i.jpg">
			        <div class="thumb-image"> <img src="images/buy8i.jpg" class="img-responsive"> </div>
			    </li>
			    <li data-thumb="images/buy8ii.jpg">
			         <div class="thumb-image"> <img src="images/buy8ii.jpg" class="img-responsive"> </div>
			    </li>
...
<div class="col-md-7 single-top-in">
				...
				//else
					//{echo 'data not enter';}
							...
							<form action ="buy8.php" method="post" name="input" class="buy"> 
							<table width="50%" border="1" cellspacing="0" cellpadding="0">
								  <tbody class="buy"> <tr>
								      <td width="40%">ITEM ID
							          <input type="text" name="id" readonly value="10018"></td>
								      <td width="60%">ITEM NAME
							            <input type="text" name="product" readonly id="s1001" value="OPPO F3"></td>
							        </tr>
								    <tr>
								      <td width="40%">PRICE (LKR) :</td>
								      <td width="60%"><input type="text" name="price" readonly id="35900" value="35900"></td>
							        </tr>
								    <tr>
								      <td>QTY :</td>
								      <td>
